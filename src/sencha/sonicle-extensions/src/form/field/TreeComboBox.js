...
Ext.define('Sonicle.form.field.TreeComboBox', {
        extend: 'Ext.form.field.Picker',
        requires: [
			'Ext.util.DelayedTask',
			'Ext.view.BoundList',
			'Ext.data.StoreManager',
			'Sonicle.selection.TreeComboBoxModel'
        ],
        alias: ['widget.sotreecombobox','widget.sotreecombo'],
        mixins: [
        ...
        onBindStore: function (store, initial) {
            ...
            if (store) {
                ...
                me.pickerSelectionModel = new Sonicle.selection.TreeComboBoxModel({
